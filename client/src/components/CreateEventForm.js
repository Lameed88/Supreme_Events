...
const CreateEvent = () => {
    ...
    const { handleImageChange:handleCoverImgChange, imgUrl:coverImg } = usePreviewImg();
    ...
    return (
        <div className="flex h-full text-left bg-white rounded-lg shadow-lg items-center mt-20 pt-20">
