...
function sendSMS(Email, otp) {
  ...
  let mailOptions = {
    ...
    to: Email,
    subject: "One Time Password - SUPREME",
    html: `Please keep your OTP confidential and do not share it with anyone. The OTP will be valid for five minutes only. <br><strong>OTP: ${otp}</strong><br><br> Here is the Registration Number: 20BCE11012 <br><br>Thank you for choosing suPREmeEvent!<br><br>If you have any questions, please contact us at:<br>Olamide: moradeyor88@gmail.com`,
  };
